...
RegisterNetEvent('a_dj:playMusic', function (YoutubeURL)
...
RegisterNetEvent('a_dj:stopMusic', function()
    for k, v in pairs(Config.Locations) do
        local src = source
        local ped = GetPlayerPed(src)
        local coords = GetEntityCoords(ped)
...
RegisterNetEvent('a_dj:pauseMusic', function()
    for k, v in pairs(Config.Locations) do
        local src = source
        local ped = GetPlayerPed(src)
        local coords = GetEntityCoords(ped)
...
RegisterNetEvent('a_dj:resumeMusic', function()
    for k, v in pairs(Config.Locations) do
        local src = source
        local ped = GetPlayerPed(src)
        local coords = GetEntityCoords(ped)
...
RegisterNetEvent('a_dj:changeVolume', function(volume)
    for k, v in pairs(Config.Locations) do
        local src = source
        local ped = GetPlayerPed(src)
        local coords = GetEntityCoords(ped)
